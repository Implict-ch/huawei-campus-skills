...
|----|------|------|--------|------------------|
| **平台自有** | `knowledge/process/`、`experiences/platform/`、`coding-problems/`、`videos/segments/` | 精编 / 官方合作内容 | 维护者脚本 + 手工 | **最高** |
| **精编卡片** | `knowledge/exam/`、`application/`、`assessment/`、`interview/`、`roles/` | 人工策展（含 `policy_effective` 政策） | 维护者手工 | **高** |
| **编译 Wiki** | `knowledge/wiki/compiled/` | 从面经确定性聚合（`compile_wiki.py`） | CI / 维护者脚本 | **中高**（面经摘要，非个案全文） |
